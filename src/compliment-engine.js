class ComplimentEngine {
    ...
    async initialize() {
        if (this.initialized) {
            console.log('✅ ComplimentEngine already initialized');
            return;
        }
        
        console.log('🚀 Initializing ComplimentEngine...');
        
        try {
            console.log('📡 Fetching compliments from /data/compliments.json...');
            ...
            console.log('📊 Compliments data loaded:', data.compliments?.length, 'compliments');
            ...
            console.log('✅ ComplimentEngine initialized successfully!');
        } catch (error) {
            console.error('❌ Failed to load compliments database:', error);
            console.log('🔄 Loading fallback compliments...');
            this.loadFallbackCompliments();
        }
    }

    async getPersonalizedCompliment(context = {}) {
        console.log('🎭 getPersonalizedCompliment called with context:', context);
        ...
        const result = this.formatComplimentResponse(selectedCompliment, temporalAnalysis);
